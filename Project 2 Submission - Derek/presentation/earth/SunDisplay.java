...
/**
 * This class is a panel displaying the sun as a circle passing over a line
 * representing it's path. 360 degrees is the left end point of the line.
 * 
...
public class SunDisplay extends JPanel {
	 ...
	 * 
	 * @param pathLength
	 *            the length of the path to draw in pixels
	 */
	 ...
	 *            the length of the path to draw in pixels
	 * @param initialSunPos
	 *            the initial position of the sun in degrees
	 */
