...
public class EarthCell {
	 ...
	 */
	public EarthCell(double northSideLength, double southSideLength,
			double verticalSideLength, double temperature,
			double percentOfRadiation, double surfaceArea) {
